...
public class AliPayService implements PayService {
    ...
    public   boolean getSignVeryfy(Map<String, String> Params, String sign) {
        ...
        if(payConfigStorage.getSign_type().equals("RSA")){
            isSign = RSA.verify(preSignStr, sign, payConfigStorage.getSecretKey(), payConfigStorage.getInput_charset());
        }
        return isSign;
    }
    ...
    private  String getOrderInfo(String subject, String body, String price,String tradeNo) {
        ...
        // 服务器异步通知页面路径
        orderInfo += "&notify_url=" + "\"" + payConfigStorage.getNotify_url() + "\"";
    ...
    public String createSign(String content, String characterEncoding) {
        return RSA.sign(content, payConfigStorage.getRsa_private(), payConfigStorage.getSign_type(), characterEncoding);
    }
    ...
    public void setPayConfigStorage(PayConfigStorage payConfigStorage) {
        ...
        String http_proxy_host = payConfigStorage.getHttp_proxy_host();
        int http_proxy_port = payConfigStorage.getHttp_proxy_port();
        String http_proxy_username = payConfigStorage.getHttp_proxy_username();
        String http_proxy_password = payConfigStorage.getHttp_proxy_password();
