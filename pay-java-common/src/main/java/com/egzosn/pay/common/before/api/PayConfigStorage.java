package com.egzosn.pay.common.before.api;
 ...
 * @see  com.egzosn.pay.common.api.PayConfigStorage
 */
@Deprecated
 public interface PayConfigStorage {
    ...
    * 签名方式
     ...
     * http代理地址
     * @return
     * @see HttpConfigStorage#getHttpProxyHost()
     */
    @Deprecated
     ...
     *   代理端口
     * @return
     * @see HttpConfigStorage#getHttpProxyPort()
     */
    @Deprecated
     ...
     * 代理用户名
     * @return
     * @see HttpConfigStorage#getHttpProxyUsername()
     */
    @Deprecated
